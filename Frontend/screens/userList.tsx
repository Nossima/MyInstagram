...
export const UserList: React.VFC<any> = ({ navigation }) => {
    const Data = [
	...
	const renderItem = (data: any) => {
		return <Dm usrImg={data.item.props.usrImg} usrName={data.item.props.usrName} lastMessage={data.item.props.usrName}/>
	}
	...
	return <View style={styles.background}>
        <View style={styles.header}>
            ...
            <Text style={[styles.tWhite, styles.nameTxt]}>New Conversation</Text>
